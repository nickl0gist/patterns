 ...
 */
public class MercedesVehicle extends Vehicle{

    private final String brandName = "Mercedes-Benz";

    public MercedesVehicle(Engine engine, GearBox gearBox, Body body) {
